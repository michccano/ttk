                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Messages Center</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-6">
                                ...
                                Import the followers you have gathered from the campaigns to start sending direct messages to them. Once you hit send, your message would be queued up and be slowly drip fed to the users.
                                                </p>
