<!DOCTYPE html>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Top Users</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
 ...
 Please wait while we gather users for you.
</div>
</div>



                <div id="SearchResults" style="display:none;" class="table-responsive">
...
$.get("http://localhost:5000/topusers", function(data, status){
   ...
   var htm = '<tr><td>'+num+'</td><td> <i class="add_h dripicons-plus" ttl="'+data.Data.items[i].author.uniqueId+'" style="size:50px;"></i><a href="#" data-toggle="tooltip" title="asdasd" data-original-title="'+data.Data.items[i].author.uniqueId+'">@'+data.Data.items[i].author.uniqueId+'</a></td><td>'+fnum(data.Data.items[i].authorStats.followingCount)+'</td><td>'+fnum(data.Data.items[i].authorStats.followerCount)+'</td><td></td></tr>';
   ...
   $("#SaveNow").click(function(){
    ...
    function(data, status){
        Swal.fire(
  'Saved.',
  $("#hashtag_name")+' has been saved to saved Users.',
  'success'
)
    });
