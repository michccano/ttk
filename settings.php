    ...
    <body class="loading" data-layout-config='{"leftSideBarTheme":"dark","layoutBoxed":false, "leftSidebarCondensed":false, "leftSidebarScrollable":false,"darkMode":false, "showRightSidebarOnStart": true}'>
        ...
        <div class="wrapper">
            ...
            <div class="content-page">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Connect to your TikTok Account</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                ...
                <!-- Standard  modal -->
                <button type="button" class="btn btn-primary" id="AddNow">Add a TikTok account</button>
                    </div>
                                    <form>
...
$.get("./system/getsavedusers", function(data, status){
   ...
   var htm = '<tr><td>'+num+'</td><td>'+data[i].un+'</td><td><i class="dripicons-document-edit"></i></td><td><i class="dripicons-document-delete del_h"></i></td></tr>';
