<!DOCTYPE html>
    ...
    <div class="form-group mb-3">
                <label for="example-select">Choose a target location for followers</label>
                <select class="form-control" id="example-select">
                    <option>1</option>
                    <option>2</option>
                    <option>3</option>
...
<div class="form-group mx-sm-3">
    ...
    <input data-toggle="touchspin" style="width:50px;" type="text" value="55">&nbsp;
...
<div class="form-group mb-3">
  ...
  <div class="custom-control custom-checkbox">
                    ...
                    <label class="custom-control-label" for="customCheck7">Emulate human behavior</label>
                      </div>
