...
var postId = '9999999999999999999';
mocha_1.describe('#listComments()', function () {
            ...
            switch (_a.label) {
                case 0:
                    ...
                    mock
                        ...
                        .reply(200, util_1.loadTestData('listComments.json'), {});
                    return [4 /*yield*/, api.listComments({ aweme_id: '9999999999999999999' })];
                case 1:
                    res = _a.sent();
                    expected = {
                        extra: {
...
mocha_1.describe('#postComment()', function () {
    mocha_1.it('a successful response should match the interface', function () { return __awaiter(void 0, void 0, void 0, function () {
        var api, mock, res, expected;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    mock
                        ...
                        .reply(200, util_1.loadTestData('postComment.json'), {});
                    return [4 /*yield*/, api.postComment(postId, 'example comment')];
                case 1:
                    res = _a.sent();
                    expected = {
                        extra: {
