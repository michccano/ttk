<!DOCTYPE html>
    ...
    <body class="loading" data-layout-config='{"leftSideBarTheme":"dark","layoutBoxed":false, "leftSidebarCondensed":false, "leftSidebarScrollable":false,"darkMode":false, "showRightSidebarOnStart": true}'>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Create/Update an account</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-6">
                                <div class="card">
                                    ...
                                    You can create or update an account from here.
                                                </p>


                    <div class="form-group mb-3">
               
               <input type="text" id="username" placeholder="Username/Email" class="form-control">
           </div>
        ...
        <select id="capabilities" multiple="" class="form-control">
            ...
            <option>Messages</option>
               ...
               <div class="form-group mb-3">
                ...
                <!-- Standard  modal -->
                <button type="button" class="btn btn-primary" id="CreateNow">Create an account</button>
                    </div>
...
$.get("./system/getsavedusers", function(data, status){
   ...
   var htm = '<tr><td>'+num+'</td><td>'+data[i].un+'</td><td><i class="dripicons-document-edit"></i></td><td><i class="dripicons-document-delete"></i></td></tr>';
   ...
   $("#CreateNow").click(function(){
    ...
    var text = $('#capabilities option:selected').toArray().map(item => item.text).join();
