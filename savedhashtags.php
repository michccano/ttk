                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Saved Hashtags</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
...
$.get("./system/getsavedhashtags", function(data, status){
   ...
   var htm = '<tr><td>'+num+'</td><td>'+data[i].hn+'</td><td><i class="dripicons-document-edit"></i></td><td><i class="dripicons-document-delete"></i></td></tr>';
