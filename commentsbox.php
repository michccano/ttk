                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Comments Box</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-6">
                                <div class="card">
                                    ...
                                    Here you can add comments that can be accessed when setting up a campaign.
                                                </p>          
...
<div class="form-group mb-3">
            <button class="btn btn-primary" type="button" id="createcomment">Add More Comments</button>
        </div>

                       
      <div class="form-group mb-3">
  
      <textarea class="form-control" id="thecomment" rows="5"></textarea>
...
$.post("./system/savecomments",{
    thecomment: $("#thecomment").val()
}).then(function(data){
    Swal.fire(
  'Saved',
...
var htm = '<tr><td>'+num+'</td><td>'+data[i].tc+'</td><td><i class="dripicons-document-edit"></i></td><td><i class="dripicons-document-delete delnow" id="'+data[i].id+'"></i></td></tr>';
